(() => {
  ...
  const I18N = {
    tr: {
      ...
      'hero.badge': 'Junior Yazılım Mühendisi · Tam zamanlı rollere açık',
      'hero.role': 'Yazılım Mühendisi · <span class="accent">Ürün, Backend & AI</span>',
      'hero.lede': 'Kamu, kurumsal ve start-up ortamlarında üretime çıkan ürünler geliştirdim. Clean Architecture, React / React Native, FastAPI ve .NET 8 ile ölçeklenebilir sistemler kuruyor; Gemini, Whisper ve iş akışı otomasyonunu birleştiren çoklu-model AI akışları tasarlıyorum.',
      ...
      'hero.meta.work': 'Kamu · Kurumsal · Start-up',
      'hero.meta.availability': 'Tam zamanlı rollere açık',

      'about.kicker': '01 — Hakkımda',
      'about.title': 'Koddan çok, <span class="accent">ürün etkisi</span> yaratmayı önemsiyorum.',
      'about.p1': 'Kamu (T.C. İletişim Başkanlığı), kurumsal (Merzigo) ve start-up (Afinitem) ortamlarında uçtan uca ürün geliştiren; backend, frontend ve mobil taraflarında canlı sistemler teslim etmiş bir Yazılım Mühendisiyim.',
      'about.availability': '<strong>Mevcut durum:</strong> Yazılım Mühendisliği lisansımı Haziran 2026\'da tamamladım; junior seviyede <strong>tam zamanlı</strong> rollere açığım.',
      'about.p2': 'Kurumsal tarafta <strong>.NET 8, Clean Architecture, CQRS ve Ocelot</strong> ile servisler; web ve mobilde <strong>React, React Native, TypeScript, React Query, Redux ve React Hook Form</strong> ile üretim kalitesinde arayüzler geliştiriyorum. Ayrıca <strong>FastAPI, PostgreSQL, Azure DevOps ve GitHub Actions</strong> ile ölçeklenebilir iş akışları kuruyor; <strong>Gemini, Whisper, OpenAI ve n8n</strong> ile hata toleranslı AI otomasyonları tasarlıyorum.',
      'about.stat.gpa': 'AGNO · 4.00',
      'about.stat.intern': 'Farklı Ekosistem<br><em class="stat__sub">Kamu · Kurumsal · Start-up</em>',
      'about.stat.shipped': 'Üretime Çıkan Sistem',
      'about.stat.certs': 'Sertifika & Program',

      'exp.kicker': '02 — Deneyim',
      'exp.title': 'Uçtan uca geliştirme · <span class="accent">backend\'den mobile</span>.',
      'exp.role.intern': 'Yazılım Stajyeri',
      'exp.role.dev': 'Yazılım Geliştirici',
      'exp.role.gdg': 'Proje Koordinatörü · Core Team',
      'date.mar2026now': 'Mart 2026 — Haziran 2026',
      'date.jun2026now': 'Haziran 2026 — Eylül 2026',
      'date.oct2025now': 'Ekim 2025 — Haziran 2026',

      /* --- experience items --- */
      'exp.merzigo.loc': 'İstanbul · Hibrit · Part-time',
      'exp.merzigo.company': 'Merzigo',
      'exp.merzigo.intern.desc': '.NET 8, C# ve PostgreSQL ile Clean Architecture ve CQRS prensiplerine uygun intranet servislerinin backend omurgasını geliştirdim. Ocelot API Gateway üzerinde çoklu ortam yönlendirmelerini, SuccessFactors API entegrasyonundaki asenkron veri akışlarını, EF Core 8 migration süreçlerini ve rol bazlı yetkilendirme / TreeView filtreleme senaryolarını yönettim. Azure DevOps, Pull Request ve StyleCop disiplinleriyle temiz, bakımı kolay kod üretimine katkı sağladım.',
      'exp.merzigo.dev.desc': 'Helpdesk ve kurumsal operasyon platformlarında state-machine tabanlı onay akışları, denetim izi mimarisi, event-driven bildirimler ve kategori bazlı görev atama mekanizmaları geliştirdim. React, TypeScript ve modern frontend pratikleriyle React Query, Redux, React Hook Form, i18n, Ant Design ve Tailwind CSS kullanarak yeniden kullanılabilir arayüzler ürettim; legacy JS/JSX ekranlarını TSX\'e taşıdım, güvenli dosya yükleme akışlarını kurguladım ve URL tabanlı filtreleme, arama ve sayfalama yapılarıyla kullanıcı deneyimini güçlendirdim.',
      'exp.merzigo.dev.loc': 'İstanbul · Hibrit · Tam zamanlı',
      'exp.merzigo.dev.company': 'Merzigo',
      ...
      'skills.title': 'Kullandığım <span class="accent">teknoloji ve ürün geliştirme yığını</span>.',
      ...
      'proj.lede': 'Faz 01: üretime çıkan ürünler · Faz 02: kurumsal mimari · Faz 03: AI otomasyonu ve veri işleme.',
      ...
      'minor.lede': 'Ürün geliştirmeden kurumsal otomasyona uzanan, farklı problem alanları için inşa ettiğim çözümler.',
      ...
      'edu.aia.meta': 'T.C. Sanayi ve Teknoloji Bakanlığı · Google · T3 · Girişimcilik Vakfı<br>Aralık 2025 — Eylül 2026',
      ...
      'edu.cert.grp.biz': 'Ürün, Proje Yönetimi & İş',
      'edu.cert.grp.lead': 'Liderlik & İletişim',

      /* --- certificates --- */
      'cert.mcp': '<strong>AI Agent Geliştirme ve MCP Temelleri</strong><em>Siber Kulüpler Birliği · 2026</em>',
      'cert.idap': '<strong>Certificate of Participation: 10th International Artificial Intelligence and Data Processing Symposium (IDAP\'26)</strong><em>İnönü Üniversitesi · IEEE · 2026</em>',
      'cert.roketsan1': '<strong>LEVEL UP AI | ROKETSAN Yapay Zekâ Hackathonu - AI Workshop</strong><em>Coderspace · 2026</em>',
      ...
      'cert.promptpro': '<strong>Start Writing Prompts like a Pro</strong><em>Google · 2026</em>',
      ...
      'cert.gpm': '<strong>Google Proje Yönetimi Professional Certificate</strong><em>Google · 2026</em>',
      'cert.gpmagile': '<strong>Çevik Proje Yönetimi</strong><em>Google · 2026</em>',
      'cert.gpmcapstone': '<strong>Proje Yönetimini Gerçek Dünyada Uygulamak</strong><em>Google · 2026</em>',
      'cert.gpmexecute': '<strong>Projeyi Yürütme: Projeyi Hayata Geçirme</strong><em>Google · 2026</em>',
      'cert.gpmplan': '<strong>Proje Planlaması: Her Şeyi Bir Araya Getirmek</strong><em>Google · 2026</em>',
      ...
      'ref.title': 'Birlikte çalıştığım <span class="accent">değerli isimler</span>.',
      'ref.lede': 'Staj ve proje süreçlerinde birlikte çalıştığım; teknik yönümü, teslim disiplinimi ve çalışma biçimimi şekillendiren ekip liderleri ve mentorlar. İletişim bilgileri talep üzerine paylaşılır.',
      ...
      'ref.iy.role': 'Teknoloji Ekibi Lideri (CTO) · Merzigo',
      'ref.iy.meta': 'Öğretim Üyesi · İstinye Üniversitesi',
      'ref.iy.ctx': 'Merzigo\'daki .NET 8 · Clean Architecture · CQRS odaklı stajımın teknik liderliğini geçmişte yürüttü.',
      ...
      'ref.gizem.name': 'Gizem Merve Cifgüvercin',
      'ref.gizem.role': 'Geliştirici Ekibi Lideri · Merzigo',
      'ref.gizem.meta': 'Software Development Lead',
      'ref.gizem.ctx': 'Merzigo\'daki backend akışlarında, servis tasarımında ve ekip içi teknik önceliklendirme süreçlerinde yön verici katkı sağladı; geliştirme disiplinimi ve karar alma refleksimi güçlendirdi.',
      'ref.tolga.name': 'Tolga Kurtuluş',
      'ref.tolga.role': 'Frontend Ekibi Lideri · Merzigo',
      'ref.tolga.meta': 'Frontend Lead',
      'ref.tolga.ctx': 'Frontend tarafındaki akış, component mimarisi ve kullanıcı deneyimi kararlarında birlikte çalıştığım; arayüz geliştirme yaklaşımıma doğrudan katkı sunan ekip lideri oldu.',
      ...
      'contact.lede': 'Junior seviyede tam zamanlı roller, freelance çalışmalar ve teknik işbirlikleri için en hızlı iletişim kanalı e-postadır.',
    ...
    en: {
      ...
      'hero.badge': 'Junior Software Engineer · Open to full-time roles',
      'hero.role': 'Software Engineer · <span class="accent">Product, Backend & AI</span>',
      'hero.lede': 'I have shipped products across public, corporate, and start-up environments. I design scalable systems with Clean Architecture, React / React Native, FastAPI, and .NET 8; and multi-model AI workflows that combine Gemini, Whisper, and automation.',
      ...
      'hero.meta.work': 'Public · Corporate · Start-up',
      'hero.meta.availability': 'Open to full-time roles',

      'about.kicker': '01 — About',
      'about.title': 'I care more about <span class="accent">product impact</span> than writing code for its own sake.',
      'about.p1': 'I\'m a Software Engineer who has delivered live systems end to end across public sector (T.C. Presidential Communications), corporate (Merzigo), and start-up (Afinitem) environments, spanning backend, frontend, and mobile.',
      'about.availability': '<strong>Current status:</strong> I completed my Software Engineering degree in June 2026 and am open to <strong>full-time</strong> junior roles.',
      'about.p2': 'On the corporate side, I build services with <strong>.NET 8, Clean Architecture, CQRS, and Ocelot</strong>; production-grade interfaces with <strong>React, React Native, TypeScript, React Query, Redux, and React Hook Form</strong>. I also design scalable workflows with <strong>FastAPI, PostgreSQL, Azure DevOps, and GitHub Actions</strong>, and fault-tolerant AI automations with <strong>Gemini, Whisper, OpenAI, and n8n</strong>.',
      'about.stat.gpa': 'GPA · 4.00',
      'about.stat.intern': 'Ecosystems<br><em class="stat__sub">Public · Corporate · Start-up</em>',
      'about.stat.shipped': 'Production Systems',
      'about.stat.certs': 'Certificates & Programs',

      'exp.kicker': '02 — Experience',
      'exp.title': 'End-to-end development · <span class="accent">backend to mobile</span>.',
      'exp.role.intern': 'Software Intern',
      'exp.role.dev': 'Software Developer',
      'exp.role.gdg': 'Project Coordinator · Core Team',
      'date.mar2026now': 'Mar 2026 — Jun 2026',
      'date.jun2026now': 'Jun 2026 — Sep 2026',
      'date.oct2025now': 'Oct 2025 — Jun 2026',

      /* --- experience items --- */
      'exp.merzigo.loc': 'Istanbul · Hybrid · Part-time',
      'exp.merzigo.company': 'Merzigo',
      'exp.merzigo.intern.desc': 'Built the backend backbone of intranet services with .NET 8, C#, and PostgreSQL under Clean Architecture and CQRS. On Ocelot API Gateway, I managed multi-environment routing, asynchronous data flows for SuccessFactors API integration, EF Core 8 migration processes, and role-based authorization / TreeView filtering scenarios. I also contributed to clean, maintainable code delivery through Azure DevOps, pull requests, and StyleCop discipline.',
      'exp.merzigo.dev.desc': 'I worked on helpdesk and corporate operations platforms, building state-machine-based approval flows, audit-trail architecture, event-driven notifications, and category-based task assignment mechanisms. Using React, TypeScript, and modern frontend practices, I delivered reusable interfaces with React Query, Redux, React Hook Form, i18n, Ant Design, and Tailwind CSS; migrated legacy JS/JSX screens to TSX; designed secure file-upload flows; and strengthened the user experience with URL-based filtering, search, and pagination.',
      'exp.merzigo.dev.loc': 'Istanbul · Hybrid · Full-time',
      'exp.merzigo.dev.company': 'Merzigo',
      ...
      'skills.title': 'My <span class="accent">technology and product development stack</span>.',
      ...
      'proj.lede': 'Phase 01: production systems · Phase 02: corporate architecture · Phase 03: AI automation and data processing.',
      ...
      'minor.lede': 'Solutions I\'ve built across product delivery and corporate automation for a wide range of problem spaces.',
      ...
      'edu.aia.meta': 'Ministry of Industry and Technology · Google · T3 · Entrepreneurship Foundation<br>Dec 2025 — Sep 2026',
      ...
      'edu.cert.grp.biz': 'Product, Project Management & Business',
      'edu.cert.grp.lead': 'Leadership & Communication',

      /* --- certificates --- */
      'cert.mcp': '<strong>AI Agent Development & MCP Fundamentals</strong><em>Cyber Clubs Association · 2026</em>',
      'cert.idap': '<strong>Certificate of Participation: 10th International Artificial Intelligence and Data Processing Symposium (IDAP\'26)</strong><em>Inönü University · IEEE · 2026</em>',
      'cert.roketsan1': '<strong>LEVEL UP AI | ROKETSAN AI Hackathon - AI Workshop</strong><em>Coderspace · 2026</em>',
      'cert.foundations': '<strong>Foundations: Data, Data, Everywhere</strong><em>Google · Coursera · 2026</em>',
      ...
      'cert.gpm': '<strong>Google Project Management Professional Certificate</strong><em>Google · 2026</em>',
      'cert.gpmagile': '<strong>Agile Project Management</strong><em>Google · 2026</em>',
      'cert.gpmcapstone': '<strong>Project Management Capstone: Applying Project Management in the Real World</strong><em>Google · 2026</em>',
      'cert.gpmexecute': '<strong>Project Execution: Running the Project</strong><em>Google · 2026</em>',
      'cert.gpmplan': '<strong>Project Planning: Putting It All Together</strong><em>Google · 2026</em>',
      ...
      'ref.lede': 'Team leads and mentors I worked with during internships and projects — people who shaped my technical direction, delivery discipline, and working style. Contact details are available on request.',
      ...
      'ref.iy.role': 'Tech Lead (CTO) · Merzigo',
      'ref.iy.meta': 'Lecturer · Istinye University',
      'ref.iy.ctx': 'He led the technical side of my Merzigo internship focused on .NET 8 · Clean Architecture · CQRS.',
      ...
      'ref.gizem.name': 'Gizem Merve Cifgüvercin',
      'ref.gizem.role': 'Development Team Lead · Merzigo',
      'ref.gizem.meta': 'Software Development Lead',
      'ref.gizem.ctx': 'She had a guiding role in backend flows, service design, and technical prioritization at Merzigo; her leadership strengthened my development discipline and decision-making reflexes.',
      'ref.tolga.name': 'Tolga Kurtuluş',
      'ref.tolga.role': 'Frontend Team Lead · Merzigo',
      'ref.tolga.meta': 'Frontend Lead',
      'ref.tolga.ctx': 'I worked with him on frontend flows, component architecture, and user-experience decisions; he had a direct influence on the way I approach interface development.',
      ...
      'contact.lede': 'For junior full-time roles, freelance work, and technical collaboration, email is the fastest way to reach me.',
